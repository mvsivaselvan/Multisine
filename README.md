...
The functions ```fftdiff``` and ```fftfilt``` can be used to perform FFT-based differentiation, integration and filtering of periodic signals measured from tests using multisine excitation.
